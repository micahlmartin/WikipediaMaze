...
{
    public class AwardNotableBadge : AwardBadgeBase
    {
        private int _badgeCount;

        public AwardNotableBadge(IRepository repository) : base(repository) { }
        ...
        {
            _badgeCount = Repository.All<Puzzle>().Count(x => x.SolutionCount >= 25 && x.CreatedById == user.Id);
